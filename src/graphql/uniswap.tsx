 ...
 * });
 */
export function usePairsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<PairsQuery, PairsQueryVariables>) {
        return ApolloReactHooks.useQuery<PairsQuery, PairsQueryVariables>(PairsDocument, baseOptions);
      }
export function usePairsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<PairsQuery, PairsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<PairsQuery, PairsQueryVariables>(PairsDocument, baseOptions);
        }
