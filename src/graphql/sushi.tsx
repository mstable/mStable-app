...
/**
 * __useSushiPairsQuery__
 *
 * To run a query within a React component, call `useSushiPairsQuery` and pass it any options that fit your needs.
 * When your component renders, `useSushiPairsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 ...
 * });
 */
export function useSushiPairsQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<SushiPairsQuery, SushiPairsQueryVariables>) {
        return ApolloReactHooks.useQuery<SushiPairsQuery, SushiPairsQueryVariables>(SushiPairsDocument, baseOptions);
      }
export function useSushiPairsLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<SushiPairsQuery, SushiPairsQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<SushiPairsQuery, SushiPairsQueryVariables>(SushiPairsDocument, baseOptions);
        }
export type SushiPairsQueryHookResult = ReturnType<typeof useSushiPairsQuery>;
export type SushiPairsLazyQueryHookResult = ReturnType<typeof useSushiPairsLazyQuery>;
export type SushiPairsQueryResult = ApolloReactCommon.QueryResult<SushiPairsQuery, SushiPairsQueryVariables>;