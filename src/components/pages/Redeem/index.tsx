...
const getTabs = (massetSymbol = 'mAsset'): Record<Tabs, { title: string; subtitle: string; component: ReactElement }> => ({
  [Tabs.Single]: {
...
export const Redeem: FC = () => {
  ...
  return massetState ? (
    <div>
      <PageHeader action={PageAction.Redeem} subtitle={tabs[activeTab as Tabs].subtitle} />
