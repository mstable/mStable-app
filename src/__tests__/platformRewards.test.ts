...
describe('platformRewards', () => {
  ...
  it('two stakers', async () => {
    ...
    // Two stakers
    expect(rewards[acct1.account]).toEqual('942.655110623117269');
    expect(rewards[acct2.account]).toEqual('57.34488937688273');
    ...
    expect(acct1Earned).toEqual('126.811093411792073498');
    expect(acct2Earned).toEqual('7.714346468300390724');
