...
export const SelectedSaveVersionProvider: FC = ({ children }) => {
  ...
  useEffect(() => {
    if (!loading && !selectedSaveVersion && !setRef.current) {
      ...
      setSelectedSaveVersion(v2Current && hasNoV1Balance ? SaveVersion.V2 : SaveVersion.V1)
      setRef.current = true
    }
  }, [loading, hasNoV1Balance, selectedSaveVersion, setSelectedSaveVersion, v2Current])
