...
const getStakingRewardsContractsMap = (
  ...
  return rawStakingRewardsContracts
    .filter(item => normalizedPoolsMap[item.stakingToken.address])
    .reduce<EarnData['stakingRewardsContractsMap']>(
      (_state: EarnData['stakingRewardsContractsMap'], data) => {
        ...
        const stakingToken = {
          ...
          price: tokenPricesMap[data.stakingToken.address],
        };

        const rewardsToken = {
          ...data.rewardsToken,
          price: tokenPricesMap[data.rewardsToken.address],
        };
